...
class VerticalTail(Component):
    ...
    def size_self(self):
        ...
        self.own_mass = 0.073*(1+0.2*F_tail)*(n_z*W_O)**0.376*q**0.122*S_VT**0.873*((100*thickness_to_chord) / np.cos(sweep_VT))**(-0.49)*(aspect_ratio_VT/np.cos(sweep_VT)**2)**0.357*taper_VT**0.039
