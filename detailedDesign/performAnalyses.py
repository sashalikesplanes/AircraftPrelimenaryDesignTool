...
from detailedDesign.climbPerformance import get_max_climb_rate, get_climb_angle, get_power_plot, calc_ROC, get_theta_plot, get_heigt_velocity_plot, get_performance_altitude_plot, get_ROC_V_plot
...
def perform_analyses(aircraft, make_stability):
    ...
    if make_stability:
        ...
        make_potato_plot(aircraft, False)
