...
specific_mass = 10000  # [w/kg] from email of saluqi
mass_motor_inverter = P_motor / specific_mass

# total weight of prop subsys
mass_total = n_fans * ( mass_fan + mass_motor_inverter)  # gearbox??
